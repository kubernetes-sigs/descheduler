...
func protectPodsWithPVCPolicy(namespace string, protectedsc []string) *apiv1alpha2.DeschedulerPolicy {
...
func TestProtectPodsWithPVC(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			policy:                  protectPodsWithPVCPolicy(namespace.Name, []string{defclass.Name}),
