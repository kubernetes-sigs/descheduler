...
func RegisterDefaultPlugins(registry pluginregistry.Registry) {
	...
	pluginregistry.Register(scaledowndeploymenthavingtoomanypodrestarts.PluginName, scaledowndeploymenthavingtoomanypodrestarts.New, &scaledowndeploymenthavingtoomanypodrestarts.ScaleDownDeploymentHavingTooManyPodRestarts{}, &scaledowndeploymenthavingtoomanypodrestarts.ScaleDownDeploymentHavingTooManyPodRestartsArgs{}, scaledowndeploymenthavingtoomanypodrestarts.ValidateScaleDownDeploymentHavingTooManyPodRestartsArgs, scaledowndeploymenthavingtoomanypodrestarts.SetDefaults_ScaleDownDeploymentHavingTooManyPodRestartsArgs, registry)
}
