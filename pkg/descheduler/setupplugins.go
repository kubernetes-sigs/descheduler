...
import (
	...
	"sigs.k8s.io/descheduler/pkg/framework/plugins/scaledowndeploymenthavingtoomanyrestarts"
)
...
func RegisterDefaultPlugins(registry pluginregistry.Registry) {
	...
	pluginregistry.Register(scaledowndeploymenthavingtoomanyrestarts.PluginName, scaledowndeploymenthavingtoomanyrestarts.New, &scaledowndeploymenthavingtoomanyrestarts.ScaleDownDeploymentHavingTooManyPodRestarts{}, &scaledowndeploymenthavingtoomanyrestarts.ScaleDownDeploymentHavingTooManyPodRestartsArgs{}, scaledowndeploymenthavingtoomanyrestarts.ValidateScaleDownDeploymentHavingTooManyPodRestartsArgs, removepodshavingtoomanyrestarts.SetDefaults_RemovePodsHavingTooManyRestartsArgs, registry)
}
