...
func addEvictionConstraintsForPvcPods(ev *DefaultEvictor, evictPvcPods bool) {
	if !evictPvcPods {
		ev.constraints = append(ev.constraints, func(pod *v1.Pod) error {
...
func addEvictionConstraintsForPodsWithoutPDB(ev *DefaultEvictor, evictPodsWithoutPDB bool, handle frameworktypes.Handle) {
	if !evictPodsWithoutPDB {
		ev.constraints = append(ev.constraints, func(pod *v1.Pod) error {
