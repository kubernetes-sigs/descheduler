...
type testCase struct {
	...
	DisabledDefaultPodProtections []DisabledDefaultPodProtection
	ExtraPodProtections           []ExtraPodProtection
}
...
func TestDefaultEvictorFilter(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			DisabledDefaultPodProtections: []DisabledDefaultPodProtection{"daemonSetPods"},
			result:                        true,
		},
		{
		...
		},
		{
			...
			ExtraPodProtections: []ExtraPodProtection{"withoutPDB"},
			result:              false,
		},
	}
...
func initializePlugin(ctx context.Context, test testCase) (frameworktypes.Plugin, error) {
	...
	defaultEvictorArgs := &DefaultEvictorArgs{
		...
		DisabledDefaultPodProtections: test.DisabledDefaultPodProtections,
		ExtraPodProtections:           test.ExtraPodProtections,
	}
