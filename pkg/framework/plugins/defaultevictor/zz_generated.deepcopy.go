...
func (in *DefaultEvictorArgs) DeepCopyInto(out *DefaultEvictorArgs) {
	*out = *in
	...
	in.PodProtectionPolicies.DeepCopyInto(&out.PodProtectionPolicies)
	if in.defaultPodProtectionPolicies != nil {
		in, out := &in.defaultPodProtectionPolicies, &out.defaultPodProtectionPolicies
		*out = make([]PodProtectionPolicy, len(*in))
		copy(*out, *in)
	}
	return
}
