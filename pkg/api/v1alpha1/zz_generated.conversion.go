...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EvictionStrategy)(nil), (*api.EvictionStrategy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_EvictionStrategy_To_api_EvictionStrategy(a.(*EvictionStrategy), b.(*api.EvictionStrategy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.EvictionStrategy)(nil), (*EvictionStrategy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_EvictionStrategy_To_v1alpha1_EvictionStrategy(a.(*api.EvictionStrategy), b.(*EvictionStrategy), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_DeschedulerPolicy_To_api_DeschedulerPolicy(in *DeschedulerPolicy, out *api.DeschedulerPolicy, s conversion.Scope) error {
	...
	out.EvictionStrategy = (*api.EvictionStrategy)(unsafe.Pointer(in.EvictionStrategy))
	return nil
}
...
func autoConvert_api_DeschedulerPolicy_To_v1alpha1_DeschedulerPolicy(in *api.DeschedulerPolicy, out *DeschedulerPolicy, s conversion.Scope) error {
	...
	out.EvictionStrategy = (*EvictionStrategy)(unsafe.Pointer(in.EvictionStrategy))
	return nil
}
...
func autoConvert_v1alpha1_EvictionStrategy_To_api_EvictionStrategy(in *EvictionStrategy, out *api.EvictionStrategy, s conversion.Scope) error {
	out.None = in.None
	out.OldestFirst = in.OldestFirst
	return nil
}

// Convert_v1alpha1_EvictionStrategy_To_api_EvictionStrategy is an autogenerated conversion function.
func Convert_v1alpha1_EvictionStrategy_To_api_EvictionStrategy(in *EvictionStrategy, out *api.EvictionStrategy, s conversion.Scope) error {
	return autoConvert_v1alpha1_EvictionStrategy_To_api_EvictionStrategy(in, out, s)
}

func autoConvert_api_EvictionStrategy_To_v1alpha1_EvictionStrategy(in *api.EvictionStrategy, out *EvictionStrategy, s conversion.Scope) error {
	out.None = in.None
	out.OldestFirst = in.OldestFirst
	return nil
}

// Convert_api_EvictionStrategy_To_v1alpha1_EvictionStrategy is an autogenerated conversion function.
func Convert_api_EvictionStrategy_To_v1alpha1_EvictionStrategy(in *api.EvictionStrategy, out *EvictionStrategy, s conversion.Scope) error {
	return autoConvert_api_EvictionStrategy_To_v1alpha1_EvictionStrategy(in, out, s)
}
