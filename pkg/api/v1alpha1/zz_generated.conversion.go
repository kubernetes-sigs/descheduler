...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeSelection)(nil), (*api.NodeSelection)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NodeSelection_To_api_NodeSelection(a.(*NodeSelection), b.(*api.NodeSelection), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.NodeSelection)(nil), (*NodeSelection)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_NodeSelection_To_v1alpha1_NodeSelection(a.(*api.NodeSelection), b.(*NodeSelection), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_NodeSelection_To_api_NodeSelection(in *NodeSelection, out *api.NodeSelection, s conversion.Scope) error {
	out.DegradationAllowed = in.DegradationAllowed
	out.NodeAffinityType = *(*[]string)(unsafe.Pointer(&in.NodeAffinityType))
	return nil
}

// Convert_v1alpha1_NodeSelection_To_api_NodeSelection is an autogenerated conversion function.
func Convert_v1alpha1_NodeSelection_To_api_NodeSelection(in *NodeSelection, out *api.NodeSelection, s conversion.Scope) error {
	return autoConvert_v1alpha1_NodeSelection_To_api_NodeSelection(in, out, s)
}

func autoConvert_api_NodeSelection_To_v1alpha1_NodeSelection(in *api.NodeSelection, out *NodeSelection, s conversion.Scope) error {
	out.DegradationAllowed = in.DegradationAllowed
	out.NodeAffinityType = *(*[]string)(unsafe.Pointer(&in.NodeAffinityType))
	return nil
}

// Convert_api_NodeSelection_To_v1alpha1_NodeSelection is an autogenerated conversion function.
func Convert_api_NodeSelection_To_v1alpha1_NodeSelection(in *api.NodeSelection, out *NodeSelection, s conversion.Scope) error {
	return autoConvert_api_NodeSelection_To_v1alpha1_NodeSelection(in, out, s)
}
...
func autoConvert_v1alpha1_StrategyParameters_To_api_StrategyParameters(in *StrategyParameters, out *api.StrategyParameters, s conversion.Scope) error {
	...
	out.NodeSelection = (*api.NodeSelection)(unsafe.Pointer(in.NodeSelection))
...
func autoConvert_api_StrategyParameters_To_v1alpha1_StrategyParameters(in *api.StrategyParameters, out *StrategyParameters, s conversion.Scope) error {
	...
	out.NodeSelection = (*NodeSelection)(unsafe.Pointer(in.NodeSelection))
