...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*DefaultTopologySpreadConstraint)(nil), (*api.DefaultTopologySpreadConstraint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_DefaultTopologySpreadConstraint_To_api_DefaultTopologySpreadConstraint(a.(*DefaultTopologySpreadConstraint), b.(*api.DefaultTopologySpreadConstraint), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.DefaultTopologySpreadConstraint)(nil), (*DefaultTopologySpreadConstraint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_DefaultTopologySpreadConstraint_To_v1alpha1_DefaultTopologySpreadConstraint(a.(*api.DefaultTopologySpreadConstraint), b.(*DefaultTopologySpreadConstraint), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_DefaultTopologySpreadConstraint_To_api_DefaultTopologySpreadConstraint(in *DefaultTopologySpreadConstraint, out *api.DefaultTopologySpreadConstraint, s conversion.Scope) error {
...
// Convert_v1alpha1_DefaultTopologySpreadConstraint_To_api_DefaultTopologySpreadConstraint is an autogenerated conversion function.
func Convert_v1alpha1_DefaultTopologySpreadConstraint_To_api_DefaultTopologySpreadConstraint(in *DefaultTopologySpreadConstraint, out *api.DefaultTopologySpreadConstraint, s conversion.Scope) error {
	return autoConvert_v1alpha1_DefaultTopologySpreadConstraint_To_api_DefaultTopologySpreadConstraint(in, out, s)
}

func autoConvert_api_DefaultTopologySpreadConstraint_To_v1alpha1_DefaultTopologySpreadConstraint(in *api.DefaultTopologySpreadConstraint, out *DefaultTopologySpreadConstraint, s conversion.Scope) error {
	out.MaxSkew = in.MaxSkew
	out.TopologyKey = in.TopologyKey
	out.WhenUnsatisfiable = v1.UnsatisfiableConstraintAction(in.WhenUnsatisfiable)
	out.Labels = *(*[]string)(unsafe.Pointer(&in.Labels))
...
// Convert_api_DefaultTopologySpreadConstraint_To_v1alpha1_DefaultTopologySpreadConstraint is an autogenerated conversion function.
func Convert_api_DefaultTopologySpreadConstraint_To_v1alpha1_DefaultTopologySpreadConstraint(in *api.DefaultTopologySpreadConstraint, out *DefaultTopologySpreadConstraint, s conversion.Scope) error {
	return autoConvert_api_DefaultTopologySpreadConstraint_To_v1alpha1_DefaultTopologySpreadConstraint(in, out, s)
}
...
func autoConvert_v1alpha1_StrategyParameters_To_api_StrategyParameters(in *StrategyParameters, out *api.StrategyParameters, s conversion.Scope) error {
	...
	out.TopologySpreadConstraint = (*api.TopologySpreadConstraint)(unsafe.Pointer(in.TopologySpreadConstraint))
...
func autoConvert_api_StrategyParameters_To_v1alpha1_StrategyParameters(in *api.StrategyParameters, out *StrategyParameters, s conversion.Scope) error {
	...
	out.TopologySpreadConstraint = (*TopologySpreadConstraint)(unsafe.Pointer(in.TopologySpreadConstraint))
	out.IncludeSoftConstraints = in.IncludeSoftConstraints
...
func autoConvert_v1alpha1_TopologySpreadConstraint_To_api_TopologySpreadConstraint(in *TopologySpreadConstraint, out *api.TopologySpreadConstraint, s conversion.Scope) error {
	out.DefaultConstraints = *(*[]api.DefaultTopologySpreadConstraint)(unsafe.Pointer(&in.DefaultConstraints))
	return nil
}
...
func autoConvert_api_TopologySpreadConstraint_To_v1alpha1_TopologySpreadConstraint(in *api.TopologySpreadConstraint, out *TopologySpreadConstraint, s conversion.Scope) error {
	out.DefaultConstraints = *(*[]DefaultTopologySpreadConstraint)(unsafe.Pointer(&in.DefaultConstraints))
	return nil
}
