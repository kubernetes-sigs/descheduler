...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeSelectionSettings)(nil), (*api.NodeSelectionSettings)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NodeSelectionSettings_To_api_NodeSelectionSettings(a.(*NodeSelectionSettings), b.(*api.NodeSelectionSettings), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.NodeSelectionSettings)(nil), (*NodeSelectionSettings)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_NodeSelectionSettings_To_v1alpha1_NodeSelectionSettings(a.(*api.NodeSelectionSettings), b.(*NodeSelectionSettings), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_NodeSelectionSettings_To_api_NodeSelectionSettings(in *NodeSelectionSettings, out *api.NodeSelectionSettings, s conversion.Scope) error {
	out.DegradationAllowed = in.DegradationAllowed
	out.NodeAffinityType = *(*[]string)(unsafe.Pointer(&in.NodeAffinityType))
	return nil
}

// Convert_v1alpha1_NodeSelectionSettings_To_api_NodeSelectionSettings is an autogenerated conversion function.
func Convert_v1alpha1_NodeSelectionSettings_To_api_NodeSelectionSettings(in *NodeSelectionSettings, out *api.NodeSelectionSettings, s conversion.Scope) error {
	return autoConvert_v1alpha1_NodeSelectionSettings_To_api_NodeSelectionSettings(in, out, s)
}

func autoConvert_api_NodeSelectionSettings_To_v1alpha1_NodeSelectionSettings(in *api.NodeSelectionSettings, out *NodeSelectionSettings, s conversion.Scope) error {
	out.DegradationAllowed = in.DegradationAllowed
	out.NodeAffinityType = *(*[]string)(unsafe.Pointer(&in.NodeAffinityType))
	return nil
}

// Convert_api_NodeSelectionSettings_To_v1alpha1_NodeSelectionSettings is an autogenerated conversion function.
func Convert_api_NodeSelectionSettings_To_v1alpha1_NodeSelectionSettings(in *api.NodeSelectionSettings, out *NodeSelectionSettings, s conversion.Scope) error {
	return autoConvert_api_NodeSelectionSettings_To_v1alpha1_NodeSelectionSettings(in, out, s)
}
...
func autoConvert_v1alpha1_StrategyParameters_To_api_StrategyParameters(in *StrategyParameters, out *api.StrategyParameters, s conversion.Scope) error {
	...
	out.NodeSelectionSettings = (*api.NodeSelectionSettings)(unsafe.Pointer(in.NodeSelectionSettings))
...
func autoConvert_api_StrategyParameters_To_v1alpha1_StrategyParameters(in *api.StrategyParameters, out *StrategyParameters, s conversion.Scope) error {
	...
	out.NodeSelectionSettings = (*NodeSelectionSettings)(unsafe.Pointer(in.NodeSelectionSettings))
