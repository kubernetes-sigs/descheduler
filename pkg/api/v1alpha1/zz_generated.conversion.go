...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MetricsConfig)(nil), (*api.MetricsConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_MetricsConfig_To_api_MetricsConfig(a.(*MetricsConfig), b.(*api.MetricsConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.MetricsConfig)(nil), (*MetricsConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_MetricsConfig_To_v1alpha1_MetricsConfig(a.(*api.MetricsConfig), b.(*MetricsConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_DeschedulerPolicy_To_api_DeschedulerPolicy(in *DeschedulerPolicy, out *api.DeschedulerPolicy, s conversion.Scope) error {
	...
	out.MetricsConfig = (*api.MetricsConfig)(unsafe.Pointer(in.MetricsConfig))
	return nil
}
...
func autoConvert_api_DeschedulerPolicy_To_v1alpha1_DeschedulerPolicy(in *api.DeschedulerPolicy, out *DeschedulerPolicy, s conversion.Scope) error {
	...
	out.MetricsConfig = (*MetricsConfig)(unsafe.Pointer(in.MetricsConfig))
	return nil
}
...
func autoConvert_v1alpha1_MetricsConfig_To_api_MetricsConfig(in *MetricsConfig, out *api.MetricsConfig, s conversion.Scope) error {
	out.NodeLabels = *(*[]string)(unsafe.Pointer(&in.NodeLabels))
	out.PodLabels = *(*[]string)(unsafe.Pointer(&in.PodLabels))
	return nil
}

// Convert_v1alpha1_MetricsConfig_To_api_MetricsConfig is an autogenerated conversion function.
func Convert_v1alpha1_MetricsConfig_To_api_MetricsConfig(in *MetricsConfig, out *api.MetricsConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_MetricsConfig_To_api_MetricsConfig(in, out, s)
}

func autoConvert_api_MetricsConfig_To_v1alpha1_MetricsConfig(in *api.MetricsConfig, out *MetricsConfig, s conversion.Scope) error {
	out.NodeLabels = *(*[]string)(unsafe.Pointer(&in.NodeLabels))
	out.PodLabels = *(*[]string)(unsafe.Pointer(&in.PodLabels))
	return nil
}

// Convert_api_MetricsConfig_To_v1alpha1_MetricsConfig is an autogenerated conversion function.
func Convert_api_MetricsConfig_To_v1alpha1_MetricsConfig(in *api.MetricsConfig, out *MetricsConfig, s conversion.Scope) error {
	return autoConvert_api_MetricsConfig_To_v1alpha1_MetricsConfig(in, out, s)
}
