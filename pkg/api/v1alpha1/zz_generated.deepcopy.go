...
func (in *DefaultTopologySpreadConstraint) DeepCopyInto(out *DefaultTopologySpreadConstraint) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DefaultTopologySpreadConstraint.
func (in *DefaultTopologySpreadConstraint) DeepCopy() *DefaultTopologySpreadConstraint {
	if in == nil {
		return nil
	}
	out := new(DefaultTopologySpreadConstraint)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TopologySpreadConstraint) DeepCopyInto(out *TopologySpreadConstraint) {
	*out = *in
	if in.DefaultConstraints != nil {
		...
		*out = make([]DefaultTopologySpreadConstraint, len(*in))
		for i := range *in {
