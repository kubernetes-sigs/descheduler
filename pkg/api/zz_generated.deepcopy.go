...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeSelectionSettings) DeepCopyInto(out *NodeSelectionSettings) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeSelectionSettings.
func (in *NodeSelectionSettings) DeepCopy() *NodeSelectionSettings {
	if in == nil {
		return nil
	}
	out := new(NodeSelectionSettings)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StrategyParameters) DeepCopyInto(out *StrategyParameters) {
	*out = *in
	...
	if in.NodeSelectionSettings != nil {
		in, out := &in.NodeSelectionSettings, &out.NodeSelectionSettings
		*out = new(NodeSelectionSettings)
		(*in).DeepCopyInto(*out)
	}
